...
![My Skills](https://skillicons.dev/icons?i=cs,dotnet,java,spring,angular,react,ts,nodejs,js,py,cpp,mysql,postgres,sqlite,visualstudio,idea,vscode,vim,windows,linux,aws,azure,docker,kubernetes,jenkins,flutter)
